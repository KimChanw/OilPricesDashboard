...
def get_gold_silver_data(item_name, start_date='2013-01-01'):
...
def get_wti_data(start_date, end_date):
    wti_price = investpy.get_price('WTI', 'USD', start=start_date, end=end_date)
    return wti_price


if __name__ == '__main__':
    get_wti_data('2023-01-01', '2023-01-02')
